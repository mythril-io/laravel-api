...
class AddGameData extends Migration
{
    ...
    public function up()
    {
        ...
        $game = Game::create([
            ...
            'synopsis' => $lipsum->paragraphs(2),
            'icon' => Str::slug('Elden Ring').".png",
            'banner' => Str::slug('Elden Ring').".jpg",
            'developer_id' => Developer::firstWhere('name', 'FromSoftware')->id,
            'user_id' => 1
        ]);
        $game->genres()->saveMany([
            Genre::firstWhere('name', 'Action Role-Playing Game')
        ...
        $game->releases()->saveMany([
            new App\Release([
                ...
                'platform_id' => Platform::firstWhere('name', 'Playstation 5')->id,
                'region_id' => Region::firstWhere('acronym', 'JP')->id,
                'publisher_id' => Publisher::firstWhere('name', 'FromSoftware')->id,
                'date' => '2022-02-25',
                'date_type_id' => 1
            ]),
            new App\Release([
                ...
                'platform_id' => Platform::firstWhere('name', 'Playstation 5')->id,
                'region_id' => Region::firstWhere('acronym', 'NA')->id,
                'publisher_id' => Publisher::firstWhere('name', 'Bandai Namco Entertainment')->id,
                'date' => '2022-02-25',
                'date_type_id' => 1
            ]),
            new App\Release([
        ...
        $game = Game::create([
            'title' => 'Overwatch 2',
            'slug' => Str::slug('Overwatch 2'),
            'synopsis' => $lipsum->paragraphs(2),
            'icon' => Str::slug('Overwatch 2').".png",
            'banner' => Str::slug('Overwatch 2').".jpg",
            'developer_id' => Developer::firstWhere('name', 'Blizzard Entertainment')->id,
            'user_id' => 1
        ]);
        $game->genres()->saveMany([
            Genre::firstWhere('name', 'MMORPG')
        ]);
        $game->releases()->saveMany([
            new App\Release([
                'game_id' => $game->id,
        ...
        $game = Game::create([
            ...
            'slug' => Str::slug('World of Warcraft'),
            'synopsis' => $lipsum->paragraphs(2),
            'icon' => Str::slug('World of Warcraft').".png",
            'banner' => Str::slug('World of Warcraft').".jpg",
            'developer_id' => Developer::firstWhere('name', 'Blizzard Entertainment')->id,
            'user_id' => 1
        ]);
        $game->genres()->saveMany([
        ...
        $game = Game::create([
            ...
            'slug' => Str::slug('World of Warcraft: Wrath of the Lich King'),
            'synopsis' => $lipsum->paragraphs(2),
            'icon' => Str::slug('World of Warcraft: Wrath of the Lich King').".png",
            'banner' => Str::slug('World of Warcraft: Wrath of the Lich King').".jpg",
            'developer_id' => Developer::firstWhere('name', 'Blizzard Entertainment')->id,
            'user_id' => 1
        ]);
        $game->genres()->saveMany([
